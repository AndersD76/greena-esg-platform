...
const tourSteps: TourStep[] = [
  {
    ...
    audioFile: '/audio/tour/step-00-boas-vindas.mp3',
  ...
  },
  {
    ...
    audioFile: '/audio/tour/step-01-cadastro.mp3',
  ...
  },
  {
    ...
    audioFile: '/audio/tour/step-02-planos.mp3',
  ...
  },
  {
    ...
    audioFile: '/audio/tour/step-03-diagnostico.mp3',
  ...
  },
  {
    ...
    audioFile: '/audio/tour/step-04-dashboard.mp3',
  ...
  },
  {
    ...
    audioFile: '/audio/tour/step-05-relatorios.mp3',
  ...
  },
  {
    ...
    audioFile: '/audio/tour/step-06-planos-acao.mp3',
  ...
  },
  {
    ...
    audioFile: '/audio/tour/step-07-certificacao.mp3',
  ...
  },
  {
    ...
    audioFile: '/audio/tour/step-08-consultoria.mp3',
  ...
  },
  {
    ...
    audioFile: '/audio/tour/step-09-conclusao.mp3',
...
export default function GuidedTour({ isOpen, onClose }: GuidedTourProps) {
  ...
  }, [stopAudio, autoPlay, currentStep]);

  // Auto-play ao mudar de step
  useEffect(() => {
    if (isOpen && autoPlay) {
      const timer = setTimeout(() => playAudio(tourSteps[currentStep].audioFile), 300);
      return () => clearTimeout(timer);
    }
  }, [currentStep, autoPlay, isOpen, playAudio]);
  ...
  }, [isOpen, currentStep, onClose, stopAudio]);
          ...
          <div className="text-center">
            ...
            {isPlaying ? (
              <button
                ...
                style={{ backgroundColor: '#e2f7d0', color: '#152F27' }}
              >
                <div className="flex items-center gap-0.5">
                  <span className="w-1 h-3 rounded-full animate-pulse" style={{ backgroundColor: '#7B9965' }} />
                  <span className="w-1 h-5 rounded-full animate-pulse" style={{ backgroundColor: '#7B9965', animationDelay: '0.15s' }} />
                  <span className="w-1 h-2 rounded-full animate-pulse" style={{ backgroundColor: '#7B9965', animationDelay: '0.3s' }} />
                  <span className="w-1 h-4 rounded-full animate-pulse" style={{ backgroundColor: '#7B9965', animationDelay: '0.45s' }} />
                  <span className="w-1 h-3 rounded-full animate-pulse" style={{ backgroundColor: '#7B9965', animationDelay: '0.6s' }} />
                </div>
                Reproduzindo...
              </button>
            ) : (
              !autoPlay && (
                <button
                  ...
                  className="inline-flex items-center gap-2 px-5 py-2.5 rounded-full text-sm font-medium text-gray-500 hover:text-gray-900 hover:bg-gray-100 transition-all"
                >
